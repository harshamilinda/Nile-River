  ...
  render() {
    return (
      <div className="App">
        ...
        <Person click={this.refreshHandler} author={this.state.authors[1].name} name=" River in Africa">There are two theories about the age of the integrated Nile. One is that the integrated drainage of the Nile is of young age, 
